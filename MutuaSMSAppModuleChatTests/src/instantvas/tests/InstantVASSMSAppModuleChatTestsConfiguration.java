...
public class InstantVASSMSAppModuleChatTestsConfiguration {
	...
	************/
	...
	public static void configureDefaultValuesForNewInstances(Instrumentation<DefaultInstrumentationProperties, String> log, 
		SMSAppModuleDALFactory baseModuleDAL, SMSAppModuleDALFactoryProfile profileModuleDAL, SMSAppModuleDALFactoryChat chatModuleDAL,
		...
		Object[] baseModule = InstantVASSMSAppModuleConfiguration.getBaseModuleInstances(log, baseModuleDAL, chatModuleCommands.values,
			/*nstNewUserTriggers*/
			new Object[][] {
	...
	static {
		...
		try {
			configureDefaultValuesForNewInstances(
				...
				SMSAppModuleDALFactoryProfile.POSTGRESQL,
				SMSAppModuleDALFactoryChat   .POSTGRESQL,
